...
public class DoctorAdminController {
  ...
  @PreAuthorize("hasRole('ADMIN')")
  public ApiResponse<Page<com.bookinghealth.api.dto.response.admin.WorkScheduleAdminResponse>>
      getWorkSchedules(
          ...
          @RequestParam(defaultValue = "10") int size) {
    return ApiResponse
        .<Page<com.bookinghealth.api.dto.response.admin.WorkScheduleAdminResponse>>builder()
        .result(
            doctorService.getWorkSchedulesForAdmin(
                date,
                clinicId,
                doctorId,
