...
public class DashboardController {
  ...
  /**
   * GET /admin/dashboard/summary?period=day|week|month Tổng quan số liệu thống kê (booking, bác sĩ,
  ...
  /** GET /admin/dashboard/revenue?filter=week|month|year Dữ liệu biểu đồ doanh thu. */
  @GetMapping("/revenue")
  ...
  /**
   * GET /admin/dashboard/booking-status?period=day|week|month Số lượng lịch hẹn theo trạng thái
  ...
  /**
   * GET /admin/dashboard/specialty-distribution?period=day|week|month Phân bố số lượt đặt theo
   * chuyên khoa.
   */
  ...
  /**
   * GET /admin/dashboard/top-doctors?period=day|week|month Top 5 bác sĩ có nhiều lượt đặt lịch nhất
   * (completed).
   */
  ...
  /** GET /admin/dashboard/recent-feedbacks Feedback có rating thấp (≤ 2 sao) gần đây nhất. */
  ...
  /** GET /admin/dashboard/pending-doctors Danh sách bác sĩ chưa được phê duyệt (status = 0). */
