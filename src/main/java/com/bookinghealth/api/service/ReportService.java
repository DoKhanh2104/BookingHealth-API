...
public class ReportService {
  ...
  public List<FinancialReportResponse> getFinancialReport(LocalDate fromDate, LocalDate toDate, Long specialtyId, Long clinicId) {
    List<Object[]> results = appointmentRepository.getFinancialReport(fromDate, toDate, specialtyId, clinicId);
  ...
  public List<PerformanceReportResponse> getPerformanceReport(LocalDate fromDate, LocalDate toDate, Long specialtyId, Long clinicId) {
    List<PerformanceReportProjection> results = appointmentRepository.getPerformanceReport(fromDate, toDate, specialtyId, clinicId);
  ...
  public List<SatisfactionReportResponse> getSatisfactionReport(LocalDate fromDate, LocalDate toDate, Long specialtyId, Long clinicId) {
    List<SatisfactionReportProjection> results = doctorReviewRepository.getSatisfactionReport(fromDate, toDate, specialtyId, clinicId);
    return results.stream().map(p -> SatisfactionReportResponse.builder()
        .id(p.getDoctorId())
